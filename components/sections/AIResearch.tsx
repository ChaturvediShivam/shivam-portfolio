          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {RESEARCH_OS.map((step, idx) => {
              ...
              return (
                ...
                >
                  {/* Step Number & Icon */}
                  <div className="relative z-10 w-16 h-16 rounded-full bg-white border-4 border-slate-100 shadow-md flex items-center justify-center transition-transform hover:scale-110 group">
                  ...
                  <div className="space-y-3 px-2">
                    <h3 className="text-lg font-bold text-consulting-navy">
                      {step.title}
                    </h3>
