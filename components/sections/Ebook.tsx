...
export default function EbookSection() {
  return (
    <section id="ebook" className="py-24 bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <ul className="grid grid-cols-1 gap-4">
                {EBOOK_DATA.takeaways.map((item, idx) => (
                  <li
                    key={idx}
                    className="flex items-start gap-3 text-consulting-slate text-sm leading-relaxed group"
                  >
                    <CheckCircle
                      size={16}
            ...
            <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-3">
              <h4 className="font-bold text-consulting-navy text-sm uppercase tracking-wider">
