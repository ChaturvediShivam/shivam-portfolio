      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="space-y-12">
              {ABOUT_CONTENT.narrative.map((item, idx) => (
                <motion.div
                  ...
                  className="relative pl-8 border-l-2 border-slate-100 hover:border-consulting-royal transition-colors group"
                >
                  <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-white border-2 border-slate-200 group-hover:border-consulting-royal transition-colors" />
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <span className="text-sm font-bold text-consulting-navy">{item.era}</span>
                      <span className="text-xs font-mono text-consulting-slate bg-slate-100 px-2 py-0.5 rounded">{item.role}</span>
                    </div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 w-full h-full bg-slate-100 rounded-2xl -z-10" />
