...
import { jobCaptureTemplate } from "./templates/job-capture";
import { jobMatchTemplate } from "./templates/job-match";
...
register(jobCaptureTemplate);
register(jobMatchTemplate);
